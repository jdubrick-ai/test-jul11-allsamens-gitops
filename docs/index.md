...
The AI Software Template that was executed comes with a sample application. This application will be built from https://github.com/jdubrick-ai/test-jul11-allsamens, stored in [quay.io/jdubrick-ai/test-jul11-allsamens](https://quay.io/jdubrick-ai/test-jul11-allsamens) and deployed through ArgoCD. 
